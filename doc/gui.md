...
| もの | 中身 |
|---|---|
| LCD | 本物の HD44780。字の絵は `roms/hd44780u_b04.bin` から引く。2 行 24 桁。レベルメータと表示器も出る（下記） |
...
firmware は LCD の**下段の左 9 マス**にレベルメータを描いている。
...
まで上がる。9 マス × 2 本 = 18 本で、実機の窓に印刷されている
`A1 A2 1 2 … 16` と数が合う。`0x80`-`0x88` は幅いっぱいの 1 本バー。
